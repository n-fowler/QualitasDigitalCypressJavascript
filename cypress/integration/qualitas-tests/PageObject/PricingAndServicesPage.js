...
class PricingAndServicesPage {
  ...
  getAdditionalTestCoverageTitle() {
    return cy.xpath(
      PricingAndServicesPageLocators.additional_test_coverage_title()
    );
  }

  getAdditionalTestCoverageBodyText() {
    return cy.xpath(
      PricingAndServicesPageLocators.additional_test_coverage_body_text()
    );
  }
  ...
  getFrameworkUpdatesBodyText() {
    return cy.xpath(
      PricingAndServicesPageLocators.framework_updates_body_text()
    );
  }

  getFrameworkUpdatesCustomTailoredBodyText() {
    return cy.xpath(
      PricingAndServicesPageLocators.framework_updates_custom_tailored_body_text()
    );
  }
  ...
  getProcessAutomationBodyText() {
    return cy.xpath(
      PricingAndServicesPageLocators.process_automation_body_text()
    );
  }
  ...
  getDashboardsOnPremiseBodyText() {
    return cy.xpath(
      PricingAndServicesPageLocators.dashboards_on_premise_body_text()
    );
  }
  ...
  getDashboardsDisclaimerBodyText() {
    return cy.xpath(
      PricingAndServicesPageLocators.dashboards_disclaimer_body_text()
    );
  }
  ...
  getTechnicalCofounderBodyText() {
    return cy.xpath(
      PricingAndServicesPageLocators.technical_cofounder_body_text()
    );
  }
}
