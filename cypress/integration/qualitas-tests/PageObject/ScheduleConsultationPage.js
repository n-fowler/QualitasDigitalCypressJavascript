...
class ScheduleConsultationPage {
    ...
    getTermsAndConditionsLink() {
        return cy.xpath(ScheduleConsultationPageLocators.terms_and_conditions_link())
    }

    getScheduleConsultationButton() {
        return cy.get(ScheduleConsultationPageLocators.schedule_consultation_button())
    }

    getScheduleConsultationButtonLink() {
        return this.getScheduleConsultationButton().find(ScheduleConsultationPageLocators.schedule_consultation_button_link())
    }
}
