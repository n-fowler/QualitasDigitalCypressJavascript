...
class HomePage {
  ...
  getSecondarySectionTitle() {
    return this.getSecondarySection().find(
      HomePageLocators.secondary_section_title()
    );
  }
  ...
  getSecondarySectionBodyText() {
    return this.getSecondarySection().find(
      HomePageLocators.secondary_section_body_text()
    );
  }

  getSecondarySectionAboutUsButton() {
    return this.getSecondarySection().find(
      HomePageLocators.secondary_section_aboutus_button()
    );
  }
  ...
  getTertiarySectionTitle() {
    return this.getTertiarySection().find(
      HomePageLocators.tertiary_section_title()
    );
  }
  ...
  getTertiarySectionBodyText() {
    return this.getTertiarySection().find(
      HomePageLocators.tertiary_section_body_text()
    );
  }

  getTertiarySectionClientTestimonialsButton() {
    return this.getTertiarySection().find(
      HomePageLocators.tertiary_section_client_testimonials_button()
    );
  }
